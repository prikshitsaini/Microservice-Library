...
public class BookServiceApplicationTests {
    ...
    Book mockBook = new Book(1, "Sky is the limit", "General",
            "Prikshit", 800.0F);

    String addBookJson = "{\"id\":4,\"title\":\"MySQL\",\"type\":\"Database\"," +
            "\"author\":\"Rohit\",\"price\":1000}";

    List<Book> mockBooks = Arrays.asList(new Book(1, "Sky is the limit", "General",
                    "Prikshit", 800.0F),
    ...
    public void retrieveBooksIssued() throws Exception {
        ...
        Mockito.when(bookService.getIssuedBooks(Mockito.anyInt())).thenReturn((mockBooks));
